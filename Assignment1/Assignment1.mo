package Assignment1
  ...
  block pid
    parameter Real kp = 7; //Proportional gain for the PID controller, no unit
    parameter Real ki = 0; //Integral gain for the PID controller, no unit
    parameter Real kd = 10; //Derivate gain for the PID controller, no unit
